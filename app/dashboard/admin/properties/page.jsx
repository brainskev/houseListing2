...
export default function AdminPropertiesPage() {
  ...
  const handleHeroToggle = async (propertyId, currentValue) => {
    // Check if trying to enable and already have 2 properties in hero
    if (!currentValue) {
      ...
      // Check if property has at least 2 images
                ...
                <div className="hidden sm:flex flex-col sm:flex-row gap-4">
                  ...
                  <div className="flex sm:flex-col gap-2 p-4 sm:items-end border-t sm:border-t-0 sm:border-l border-gray-100">
                    ...
                    {isAdmin && (
                      <button
                        onClick={() => setDeleteModal(property)}
                        className="inline-flex items-center gap-1 px-3 py-2 rounded-md text-xs font-semibold bg-red-100 text-red-700 hover:bg-red-200 transition whitespace-nowrap"
                      >
                        <FaTrash /> Delete
                      </button>
                    )}
